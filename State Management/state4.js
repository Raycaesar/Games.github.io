...
export class SittingLeft extends State{
    ...
    handleInput(input){
        if (input === 'RELEASE right') this.player.setState(states.SITTING_RIGHT);
        else if(input === 'PRESS up') this.player.setState(states.STANDING_LEFT);
        else if(input === 'PRESS left') this.player.setState(states.ROLLING_LEFT);
...
export class SittingRight extends State{
    ...
    handleInput(input){
        if (input ===  'RELEASE left') this.player.setState(states.SITTING_LEFT);
        else if(input === 'PRESS up') this.player.setState(states.STANDING_RIGHT);
        else if(input === 'PRESS right') this.player.setState(states.ROLLING_RIGHT);
...
export class FallingLeft extends State{
    ...
    handleInput(input){
        ...
        else if(input === 'PRESS down') this.player.weight++; 
        else if(input === 'RELEASE down') this.player.weight =1; 
...
export class RollingLeft extends State{
    ...
    enter(){
        ...
        this.player.maxFrame = 6;
        this.player.speed = -this.player.maxSpeed * 1.2;
        //this.player.weight = 1;
    }
    handleInput(input){ 
        if (input === 'PRESS right') this.player.setState(states.STANDING_LEFT);
        //else if(input === 'PRESS left') this.player.setState(states.RUNNING_LEFT);
        else if(input === 'PRESS down' && this.player.onGround()) this.player.setState(states.SITTING_LEFT); 
        else if(input === 'PRESS up') this.player.vy -= 20;
        else if(input === 'PRESS down' && !this.player.onGround()) this.player.weight *= 1.5;
        else if(input === 'RELEASE down'&& !this.player.onGround()) this.player.weight =1;  
...
export class RollingRight extends State{
    ...
    handleInput(input){ 
        ...
        else if(input === 'PRESS down' && this.player.onGround()) this.player.setState(states.SITTING_RIGHT); 
        else if(input === 'PRESS up') this.player.vy -= 20 && !this.player.y < 0 ;
        else if(input === 'PRESS down' && !this.player.onGround()) this.player.weight *= 1.5;
        else if(input === 'RELEASE down'&& !this.player.onGround()) this.player.weight =1; 
