import {StandingLeft, StandingRight, SittingLeft, SittingRight, RunningLeft, RunningRight, JumpingLeft, JumpingRight, FallingLeft, FallingRight, RollingLeft, RollingRight } from "./state4.js";
...
export default class Player{
    ...
    update(input){
        ...
        if (this.y >this.gameHeight - this.height) this.y = this.gameHeight - this.height;// guarantee dog's body not lower than the ground.
