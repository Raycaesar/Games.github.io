...
const enemy1 = new Enemy(canvas.width, canvas.height); //remember add this constant after we finish the class
...
function animate(){
	...
	player.update(input);
	enemy1.draw(ctx);
	enemy1.update();//remember they should be drawed in animation
